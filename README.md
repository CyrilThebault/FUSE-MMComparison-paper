...
**"Comparing multi-model mosaic and multi-model combination methods to simulate streamflow across the contiguous USA"** (Hydrology and Earth System Sciences, HESS)
